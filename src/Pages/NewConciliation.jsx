  ...
  return (
    <>
      <div className="p-4 sm:ml-56 h-full">
        <div className="p-4 border-2 h-full border-green_primary  border-dashed rounded-md mb-12 mt-20">
          <InputsHeaderConciliation isdataSaved={[isDataBankSaved, isDataBookSaved]} dataBank={dataBankSaved} dataBook={dataBookSaved} />
          <div className="grid grid-cols-2 items-center gap-3 mb-4">
            <div className="flex items-center justify-center bg-gray-50 overflow-x-auto overflow-y-auto  ">
              <InputTableBook dataBook={dataBook} setDataBook={setDataBook} setIsDataBookSaved={setIsDataBookSaved} setDataBookSaved={setDataBookSaved} />
            </div>
            <div className="flex items-center justify-center bg-gray-50 overflow-x-auto overflow-y-auto ">
              <InputTableBank  dataBank={dataBank} setDataBank={setDataBank}  setIsDataBankSaved={setIsDataBankSaved} setDataBankSaved={setDataBankSaved} />
            </div>
          </div>
          <ConciliationsResult />
        </div>
